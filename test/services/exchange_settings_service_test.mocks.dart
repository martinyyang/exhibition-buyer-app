...
// in exhibition_buyer_app/test/services/exchange_settings_service_test.dart.
...
class MockFormulaHistoryService extends _i1.Mock
    implements _i5.FormulaHistoryService {
  MockFormulaHistoryService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> saveFormula(
    String? formula,
    String? teamId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<List<String>> getRecentFormulas(String? teamId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getRecentFormulas,
          [teamId],
  ...
  @override
  _i3.Future<List<Map<String, dynamic>>> getMostUsedFormulas(
    String? teamId,
    int? limit,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<Map<String, dynamic>?> getFormulaByText(
    String? teamId,
    String? formula,
  ) =>
      (super.noSuchMethod(
